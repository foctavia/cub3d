...
/*   Updated: 2022/11/22 15:33:45 by owalsh           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	add_color(int id, char *line, int *i, t_game *game)
{
	...
	if (id == FLOOR)
	{
		...
		game->map->floor->hex = from_rgb_to_hex(game->map->floor->red, game->map->floor->green, game->map->floor->blue);
	...
	if (id == CEILING)
	{
		...
		game->map->ceiling->hex = from_rgb_to_hex(game->map->ceiling->red, game->map->ceiling->green, game->map->ceiling->blue);
